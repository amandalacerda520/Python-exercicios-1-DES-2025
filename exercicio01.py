...
curso01 = int(input("digite o numero de avaliação do curso01"))
curso02 = int(input("digite o numero de avaliação do curso02"))

if curso_01 > curso02:
    print("curso01 teve mais avaliação")
else: 
    print("curso02 teve mais.")